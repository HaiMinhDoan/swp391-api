...
public class TeacherCvController extends BaseController<TeacherCv, Integer, TeacherCvRequestDto, TeacherCvResponseDto> {
    ...
    protected TeacherCv toEntity(TeacherCvRequestDto requestDto) {
        ...
        teacherCv.setTitle(requestDto.getTitle());
        teacherCv.setDescription(requestDto.getDescription());
        teacherCv.setCvUrl(requestDto.getCvUrl());
        teacherCv.setExperience(requestDto.getExperience());
        teacherCv.setSkills(requestDto.getSkills());
        teacherCv.setEducations(requestDto.getEducations());
        teacherCv.setCertificates(requestDto.getCertificates());
        teacherCv.setStatus(requestDto.getStatus() != null ? requestDto.getStatus() : 1);
        teacherCv.setRejectReason(requestDto.getRejectReason());
