...
@Setter
@Entity
@Table(name = "teacher_cv", uniqueConstraints = {
        @UniqueConstraint(name = "teacher_cv_unique", columnNames = {"user_id"})
})
public class TeacherCv {
    ...
    @Column(name = "educations", length = Integer.MAX_VALUE)
    private String educations;

    @Column(name = "certificates", length = Integer.MAX_VALUE)
