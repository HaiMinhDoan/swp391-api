...
```
cd existing_repo
git remote add origin https://gitlab.com/taraacademydev/tara-academy-api.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/taraacademydev/tara-academy-api/-/settings/integrations)
